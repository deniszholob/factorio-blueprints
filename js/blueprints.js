...
export const blueprintData = [
  ...
  blueprintEntry("1.0", false, true, "Train/Station Colors", "bp-train-station-colors", "train, rail"),
  ...
  blueprintEntry("0.18", true, false, "Builds: Bots + Beacons + Trains", "book-builds-train-super-bot", "train, rail, circuits, gears, smelting, super, mega, giga"),
  blueprintEntry("0.18", true, true, "Bot MEF/Mall (MojoD + Rain Remix)", "book-mef-bot-not-a-mall", "make everything factory, logic, circuits, shopping"),
  ...
  blueprintEntry("1.0", true, false, "Rails 2 Lane RHD (MojoD Remix)", "book-rails-2-lane-rhd-mojod-remix", "train, rail, intersection"),
  blueprintEntry("1.0", true, false, "PAX Stations", "book-pax-stations", "player, access, train, rail, taxi"),
  blueprintEntry("1.0", true, false, "Outpost Stations", "book-rail-outpost-stations", "train, rail, taxi, mine, mining, ore"),
