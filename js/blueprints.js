...
export const blueprintData = [
  ...
  blueprintEntry("0.18", true, false, "Builds: Bots + Beacons + Trains", "book-builds-train-super-bot", "train, rail, track, circuits, gears, smelting, super, mega, giga"),
  ...
  blueprintEntry("1.0", true, false, "Game in a book (Big, loads slow)", "book-game"),
